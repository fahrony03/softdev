  ...
  <div class="row">
   ...
   <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <br><br>
        <h2><p style="text-align:center">Saran</p></h2>
          <p style="text-align:center">Masukan dari kalian sangat membantu dalam pengembangan website kami</p>
